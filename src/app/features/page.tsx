...
export const metadata: Metadata = {
  ...
  description: 'Discover powerful AI features that transform hours of meetings into minutes of actionable insights. 99.9% accurate transcription, GPT-4 powered analysis, and seamless collaboration.',
  keywords: 'AI transcription, meeting notes, GPT-4, speaker recognition, meeting analysis, productivity tools',
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Powered by OpenAI Whisper with automatic speaker identification
              </p>
              <ul className="space-y-3">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Identifies and labels speakers automatically
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Handles accents and technical jargon
                </li>
              </ul>
            </div>
            ...
            {/* Feature 3: Seamless Collaboration */}
            <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Distribute insights instantly across your team
              </p>
              <ul className="space-y-3">
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
              Before & After Clarnote
            </h2>
            <p className="text-xl text-gray-600">
              See the transformation in your meeting workflow
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-gray-400 mb-8">Before</h3>
            ...
            {/* After */}
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-8">After</h3>
              <div className="space-y-4">
                <div className="flex items-center text-gray-900">
                  <svg className="w-6 h-6 text-green-500 mr-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  Automated capture of everything
                </div>
                <div className="flex items-center text-gray-900">
                  <svg className="w-6 h-6 text-green-500 mr-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Advanced capabilities to supercharge your productivity
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600">Find any conversation instantly</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Custom Tags</h3>
              <p className="text-sm text-gray-600">Organize meetings your way</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600">Track meeting patterns</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600">MP3, WAV, MP4, M4A files</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600">Process multiple meetings</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Team Workspace</h3>
              <p className="text-sm text-gray-600">Collaborate on meetings</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600">iOS & Android native apps</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">SOC 2 Type II compliant</h3>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">GDPR & CCPA compliant</h3>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">SSO/SAML support</h3>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Always available when you need it</p>
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12">
            Join thousands of professionals saving 5+ hours per week
          </p>
